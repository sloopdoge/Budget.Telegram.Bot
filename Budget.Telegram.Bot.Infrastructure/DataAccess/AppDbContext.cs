...
namespace Budget.Telegram.Bot.Infrastructure.DataAccess;

public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    public DbSet<TelegramUser> TelegramUsers { get; set; }
    public DbSet<UsersGroup> UsersGroups { get; set; }
    public DbSet<Domain.Entities.Budget> Budgets { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UsersGroup>()
            ...
            .UsingEntity<Dictionary<string, object>>(
                "UsersGroupBudget",
                j => j.HasOne<Domain.Entities.Budget>().WithMany().HasForeignKey("BudgetId"),
                j => j.HasOne<UsersGroup>().WithMany().HasForeignKey("UsersGroupId"));
        
        modelBuilder.Entity<Domain.Entities.Budget>()
